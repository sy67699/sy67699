  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">HOmePage</a></h1>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        while($data1 = mysqli_fetch_array($query1))
        {
            if($count1==0)
            {
                ...
                <div class="carousel-background"><img src="upload/'.$data1['image'].'" alt=""></div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
             ...
             yyyyyyyyyyyyyy
             zzzzzzzzzzzzzzz <br>
              <strong>Phone:</strong> +917800591620<br>
              <strong>Email:</strong> sy67699@gmail.com<br>
            </p>
